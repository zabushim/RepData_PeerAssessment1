...
Mean: `r stepsMean` and Median: `r stepsMedian` steps taken per day
...
--- | --- | ---
Activity with missing data | `r stepsMean` | `r stepsMedian`
Activity with imputed mean data | `r stepsimputeMean` | `r stepsimputeMedian`
